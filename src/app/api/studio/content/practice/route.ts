...
import {
  ...
  updateCategory,
  updateSentence,
} from "@/lib/practiceContentStore";

/**
 * CRUD-API voor de Praktijkzinnen-content (categorieën + zinnen) — draai dit
 * lokaal (`npm run dev`), niet op Vercel (read-only filesystem daar, zie
 * practiceContentStore.ts). Zit achter dezelfde studio-wachtwoordgate als de
 * rest van /api/studio/* (middleware.ts).
 */
